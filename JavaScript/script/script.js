...
// // console.log(a === b) // value - data type
// // console.log(a !== b) // value - data type
// // console.log(a != b) // value - data type
...
// else if (degree < 70) console.log('f')
// else console.log('enter a valid degree')
...
// var tracks = ['web design' , 'ccns' , 'network']

// console.log(tracks.includes('graphics'))

// if(!tracks.includes('graphics'))
// console.log(tracks)
// else tracks.push('graphics')
// console.log(tracks)


// or ///if(!tracks.includes('graphics'))
...
function changeClick() {
      ...
      if (img.src == "file:///E:/FrontEnd_Rodmap(AI)/nti2/JavaScript/imag/download3.jpg")
            img.src = "imag/download4.jpg"
      else img.src = "imag/download3.jpg"
}
